...
function getAllPosts() {
    ...
    fetch('http://localhost:3000/posts') // Changed from index.php
...
function loadComments(post_id) {
    ...
    fetch(`http://localhost:3000/comments/${post_id}`) // Changed from index.php
    .then(response => response.json())
    .then(comments => {
...
function addComment(post_id) {
    ...
    fetch('http://localhost:3000/comments', { // Changed from index.php
        method: 'POST',
        headers: {
...
function deletePost(title) {
    fetch(`http://localhost:3000/posts/title/${encodeURIComponent(title)}`, {
        method: 'DELETE'
    })
    .then(response => response.json())
    .then(data => {
